...
<div class="page--yuzo__welcome">
    ...
    <div class="page--body">
        <h2 class="nav-tab-wrapper">
            <a class='nav-tab <?php if( !isset($_GET['tab']) || $_GET['tab'] == 'new' ){ echo "nav-tab-active"; } ?>' href='<?php echo admin_url( 'options-general.php?page=yuzo-welcome&tab=new' ); ?>'>New 5.10</a>
        ...
        <div class="page--yuzo__new">
            ...
            <div class="col-group wow flipInX animated" data-wow-duration="0.8s" data-wow-delay="0.2s" style="width:590px;float:right;">
                <div>
                    <h2>The fastest</h2>
    ...
    <?php elseif( isset($_GET['tab']) && $_GET['tab']=='faq' ): ?>
        ...
        <div class="page--yuzo__support">
            ...
            <p>Yuzo have its free version will always be available, but you can not die without knowing the new version PRO. (very soon).</p>
        </div>
